...
- (void)share {
    ...
    if (model) {
        NSArray *activities = @[[[WechatActivity alloc] init],
        ...
        [imageView sd_setImageWithURL:model.hp_img_original_url];
        NSURL *url = model.web_url;
        
        NSArray *activityItems = @[imageView.image, textToShare, url];
        ...
        UIActivityViewController *activityCtrl = [[UIActivityViewController alloc] initWithActivityItems:activityItems applicationActivities:activities];
